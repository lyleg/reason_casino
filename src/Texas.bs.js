...
function make() {
  ...
  newrecord[/* reducer */12] = (function (action, state) {
      if (action) {
        ...
        var dealer = match[1];
        var deck = state[/* deck */0];
        var match$1 = state[/* round */2];
        var match$2;
        switch (match$1) {
          case 0 : 
              var match$3 = TexasGame$ReactTemplate.dealToDealer(deck, dealer, 0);
              match$2 = /* tuple */[
                match$3[0],
                match$3[1],
                /* Flop */1
              ...
              break;
          case 1 : 
              var match$4 = TexasGame$ReactTemplate.dealToDealer(deck, dealer, 3);
              match$2 = /* tuple */[
                match$4[0],
                match$4[1],
                /* Middle */2
              ...
              break;
          case 2 : 
              var match$5 = TexasGame$ReactTemplate.dealToDealer(deck, dealer, 1);
              match$2 = /* tuple */[
                match$5[0],
                match$5[1],
                /* River */3
              ...
              break;
          case 3 : 
              var match$6 = TexasGame$ReactTemplate.dealToDealer(deck, dealer, 1);
              match$2 = /* tuple */[
                match$6[0],
                match$6[1],
                /* End */4
              ...
              break;
          case 4 : 
              var match$7 = TexasGame$ReactTemplate.dealToDealer(deck, dealer, 0);
              match$2 = /* tuple */[
                match$7[0],
                match$7[1],
                /* End */4
        ...
        var match$8 = TexasGame$ReactTemplate.deal(state[/* players */1]);
        return /* Update */Block.__(0, [/* record */[
                    /* deck */match$8[0],
                    /* players */match$8[1],
                    /* round : Flop */1,
